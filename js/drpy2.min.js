...
<head data-suburl="">
	...
	<title>ddx/TVBox: All content is for learning only, please do not use it for illegal purposes. - js/drpy2.min.js at master - Agit</title>
	<meta name="theme-color" content="#6cc644">
	<meta name="author" content="ddx" />
	...
	<meta name="_csrf" content="HNXYUWH6WraJ_zbUfGZB9SAzUM86MTcwMTE4ODEwNTExNzM4MzY0MQ" />
	...
	<script>
		window.config = {
			...
			csrf: 'HNXYUWH6WraJ_zbUfGZB9SAzUM86MTcwMTE4ODEwNTExNzM4MzY0MQ',
			HighlightJS: false,
			SimpleMDE: false,
			Tribute: false,
			U2F: false,
	...
	<style class="list-search-style"></style>
		...
		<meta property="og:url" content="https://agit.ai/ddx/TVBox" />
	...
	<meta property="og:type" content="object" />
		...
		<meta property="og:image" content="https://agit.ai/user/avatar/ddx/-1" />
...
<div class="right stackable menu header-right">
	...
	<a class="item" rel="nofollow" href="/user/login?redirect_to=%2fddx%2fTVBox%2fsrc%2fbranch%2fmaster%2fjs%2fdrpy2.min.js">
...
<div id="repoHome" class="repository file list ">
	...
	<div class="ui container">
		<div class="repo-header">
			...
			<svg viewBox="0 0 16 16" class="svg octicon-repo-forked" width="32" height="32" aria-hidden="true"><path fill-rule="evenodd" d="M5 3.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm0 2.122a2.25 2.25 0 10-1.5 0v.878A2.25 2.25 0 005.75 8.5h1.5v2.128a2.251 2.251 0 101.5 0V8.5h1.5a2.25 2.25 0 002.25-2.25v-.878a2.25 2.25 0 10-1.5 0v.878a.75.75 0 01-.75.75h-4.5A.75.75 0 015 6.25v-.878zm3.75 7.378a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm3-8.75a.75.75 0 100-1.5.75.75 0 000 1.5z"/></svg>
				...
				<div class="fork-flag">派生自 <a href="/Yoursmile7/TVBox">Yoursmile7/TVBox</a></div>
				
			</div>
			
				<div class="repo-buttons">
					<form method="post" action="/ddx/TVBox/action/watch?redirect_to=%2fddx%2fTVBox%2fsrc%2fbranch%2fmaster%2fjs%2fdrpy2.min.js">
						<input type="hidden" name="_csrf" value="HNXYUWH6WraJ_zbUfGZB9SAzUM86MTcwMTE4ODEwNTExNzM4MzY0MQ">
						<div class="ui labeled button poping up" tabindex="0" data-content="请登录后再关注此仓库" data-position="top center" data-variation="tiny">
							...
							<a class="ui basic label" href="/ddx/TVBox/watchers">
								5
							</a>
						</div>
					</form>
					<form method="post" action="/ddx/TVBox/action/star?redirect_to=%2fddx%2fTVBox%2fsrc%2fbranch%2fmaster%2fjs%2fdrpy2.min.js">
						<input type="hidden" name="_csrf" value="HNXYUWH6WraJ_zbUfGZB9SAzUM86MTcwMTE4ODEwNTExNzM4MzY0MQ">
						<div class="ui labeled button poping up" tabindex="0" data-content="请登录后再点赞此仓库" data-position="top center" data-variation="tiny">
							...
							<a class="ui basic label" href="/ddx/TVBox/stars">
								1
							</a>
						</div>
					</form>
							...
							<a class="ui compact basic button
								poping up"
								 data-content="登录并 派生 这个仓库。" rel="nofollow"
									href="/user/login?redirect_to=/repo/fork/12020"
								 data-position="top center" data-variation="tiny">
								<i class="mr-2xs iconfont icon-fork"></i>派生
							</a>
							<a class="ui basic label" href="/ddx/TVBox/forks">
								2
							</a>
						</div>
	...
	<div class="ui tabs container">
			...
			<div class="ui tabular stackable menu navbar">
				...
				<a class="active item" href="/ddx/TVBox">
					<i class="iconfont icon-code"></i> 代码
				</a>
				

				
					<a class=" item" href="/ddx/TVBox/issues">
	...
	<span class="repo-url hidden">/ddx/TVBox</span>
	<span class="repo-id hidden">12020</span>
	<div class="ui container">
	...
	<div class="ui segment sub-menu repository-menu">
		<div class="ui two horizontal center link list">
				...
				<div class="item">
					<a class="ui" href="/ddx/TVBox/commits/branch/master"><i class="iconfont icon-commit"></i> <b>1989</b> 提交</a>
				</div>
			
			
				<div class="item">
					<a class="ui" href="/ddx/TVBox/branches/"><i class="iconfont icon-branch-down"></i> <b>1</b> 分支</a>
				</div>
				<div class="item">
					<span class="ui"><i class="iconfont icon-memory"></i> <b id="RepoSize">1.4 GB</b></span>
				</div>
	...
	<a class="ui segment language-stats">
		...
		<div class="bar" style="width: 96.8%; background-color: #f1e05a">&nbsp;</div>
		
		<div class="bar" style="width: 3.2%; background-color: #3572A5">&nbsp;</div>
	...
	<div class="ui floating filter dropdown custom" data-can-create-branch="false" data-no-results="未找到结果">
		...
		<div class="data" style="display: none" data-mode="branches">
				...
				<div class="item branch selected" data-url="/ddx/TVBox/src/branch/master/js/drpy2.min.js">master</div>
		...
		<div class="menu transition" :class="{visible: menuVisible}" v-if="menuVisible" v-cloak>
			...
			<div class="scrolling menu" ref="scrollContainer">
				...
				<div class="item" v-if="showCreateNewBranch" :class="{active: active == filteredItems.length}" :ref="'listItem' + filteredItems.length">
					...
					<form ref="newBranchForm" action="/ddx/TVBox/branches/_new/branch/master" method="post">
						<input type="hidden" name="_csrf" value="HNXYUWH6WraJ_zbUfGZB9SAzUM86MTcwMTE4ODEwNTExNzM4MzY0MQ">
			...
			<div class="message" v-if="showNoResults">${ noResults }</div>
				...
				<div class="fitted item">
					<span class="ui breadcrumb repo-path">
						<a class="section" href="/ddx/TVBox/src/branch/master" title="TVBox">TVBox</a>
						
							<span class="divider">/</span>
							
								<span class="section">
									<a href="/ddx/TVBox/src/branch/master/js" title="js">js</a></span>
		...
		<div class="file-header-right df ac">
			<div class="ui right file-actions">
				<div class="ui buttons">
					<a class="ui button" href="/ddx/TVBox/raw/branch/master/js/drpy2.min.js">原始文件</a>
					
						<a class="ui button" href="/ddx/TVBox/src/commit/8bd934062fae5aac0936aa1125f4d911def945d4/js/drpy2.min.js">永久链接</a>
					
					
						<a class="ui button" href="/ddx/TVBox/blame/branch/master/js/drpy2.min.js">Blame</a>
					
					<a class="ui button" href="/ddx/TVBox/commits/branch/master/js/drpy2.min.js">文件历史</a>
				</div>
